...
@section('title','Pol�tica e Privacidade')
...
<div class="min-h-dvh bg-white text-slate-900">
  <header class="sticky top-0 z-10 bg-white/80 backdrop-blur border-b border-slate-100">
    <div class="mx-auto max-w-lg px-4 py-3 flex items-center gap-3">
      ...
      <h1 class="text-lg sm:text-xl font-semibold">Pol�tica e Privacidade</h1>
    </div>
  </header>

  <main class="mx-auto max-w-lg px-6 py-6 pb-24 prose prose-slate prose-sm">
    <h2>1. Introdu��o</h2>
    <p>Esta Pol�tica descreve como coletamos e tratamos seus dados no aplicativo VISIT Altamira.</p>

    <h3>2. Dados que coletamos</h3>
    <ul>
      <li>Dados de conta: nome, e-mail (opcional), CPF (se informado).</li>
      <li>Dados de uso: avalia��es de pontos tur�sticos e empresas.</li>
    </ul>

    <h3>3. Finalidades</h3>
    <ul>
      <li>Manter e melhorar sua experi�ncia no app.</li>
      <li>Exibir e moderar avalia��es.</li>
    </ul>

    <h3>4. Seus direitos</h3>
    <p>Voc� pode solicitar acesso, corre��o e exclus�o dos seus dados pelo menu <strong>Minha Conta</strong>.</p>

    <h3>5. Contato</h3>
    <p>Para d�vidas, entre em contato com a SEMTUR.</p>

    <p class="text-xs text-slate-500 mt-6">�ltima atualiza��o: {{ now()->format('d/m/Y') }}</p>
  </main>
</div>
