...
>
    ...
    <section class="grid gap-6 xl:grid-cols-[minmax(0,1fr)_360px]">
        <div class="space-y-6">
            <x-dashboard.section-card title="Dados principais" subtitle="Estruture o ano e o conteúdo base da edição">
        ...
        <div class="space-y-6">
            <x-dashboard.section-card title="Publicação" subtitle="Controle o estado editorial da edição">
                <div>
                ...
                <div class="mt-4 rounded-2xl border border-[var(--ui-border)] bg-[var(--ui-surface-soft)] px-4 py-4 text-sm text-[var(--ui-text-soft)]">
                    Para publicar, mantenha o texto preenchido e envie uma capa válida para a edição.
                </div>
            </x-dashboard.section-card>

            <x-dashboard.section-card title="Capa da edição" subtitle="Imagem usada como destaque da edição">
                <div>
                    ...
                    <div class="mt-4 overflow-hidden rounded-2xl border border-[var(--ui-border)] bg-[var(--ui-surface-soft)]">
                        <div class="flex h-56 items-center justify-center">
                            ...
                            <template x-if="!coverPreview || removeCover">
                                <div class="text-sm text-[var(--ui-text-soft)]">Prévia da capa da edição</div>
                            </template>
                        </div>
                    </div>
            ...
            @if($isEdit)
                <x-dashboard.section-card title="Resumo" subtitle="Base pronta para a Fase 2B">
                    <dl class="space-y-3 text-sm">
                        ...
                        <div class="flex items-center justify-between gap-3">
                            <dt class="text-[var(--ui-text-soft)]">Vídeos cadastrados</dt>
