...
return new class extends Migration {
    ...
    {
        Schema::create('onde_ficar_paginas', function (Blueprint $table) {
            $table->id();

            $table->string('titulo', 180)->default('Onde ficar em Altamira');
            $table->string('subtitulo', 180)->nullable();
            $table->text('resumo')->nullable();

            $table->longText('texto_intro')->nullable();
            $table->longText('texto_hospedagem_local')->nullable();
    ...
    {
        Schema::dropIfExists('onde_ficar_paginas');
    }
};
