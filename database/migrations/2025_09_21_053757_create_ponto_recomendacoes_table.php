...
return new class extends Migration {
    public function up(): void {
        Schema::create('ponto_recomendacoes', function (Blueprint $table) {
            $table->id();
            ...
            $table->timestamps();
            $table->softDeletes();
            $table->unique(['ponto_turistico_id', 'categoria_id'], 'ponto_cat_unq');
        });
    }
    public function down(): void {
        Schema::dropIfExists('ponto_recomendacoes');
    }
};
