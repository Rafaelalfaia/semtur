...
class RotaDoCacau extends Model
{
    use SoftDeletes;

    protected $table = 'rota_do_cacau';
    ...
    protected static function booted(): void
    {
        static::saving(function (self $model) {
            $base = trim((string) ($model->slug ?: $model->titulo ?: 'rota-do-cacau'));
    ...
    {
        return $this->hasMany(RotaDoCacauEdicao::class, 'rota_do_cacau_id')
            ->orderByDesc('ano')
            ->orderBy('ordem')
            ->orderBy('id');
    }
